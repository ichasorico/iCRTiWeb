...
<head>
  ...
  <title>iCRTi Consulting S.L.</title>
    ...
    <div class="mbr-section__container">
        <div>
            ...
            <div class="carousel-inner" role="listbox">
                <div class="mbr-box mbr-section mbr-section--relative mbr-section--fixed-size mbr-section--bg-adapted item dark center mbr-section--full-height active" style="background-image: url(assets/images/iphone-1067991-1920-1920x1440-38.jpg);">
                    <div class="mbr-box__magnet mbr-box__magnet--sm-padding mbr-after-navbar">
                        <div class=" container">
                            
                            <div class="row"><div class="col-sm-8 col-sm-offset-2">
                                <div class="mbr-hero">
                                    <h1 class="mbr-hero__text">NO TE MOJES CON OTROS</h1>
                                    <p class="mbr-hero__subtext">Nosotros te implantamos un modelo de Integración Continua y Entrega Continua para que consigas que tu empresa sea DEV-Ops friendly.</p>
                                </div>
                ...
                </div><div class="mbr-box mbr-section mbr-section--relative mbr-section--fixed-size mbr-section--bg-adapted item dark center mbr-section--full-height" style="background-image: url(assets/images/iphone-1067982-1920-1920x1439-71.jpg);">
                    <div class="mbr-box__magnet mbr-box__magnet--sm-padding mbr-after-navbar">
                        <div class=" container">
                ...
                </div><div class="mbr-box mbr-section mbr-section--relative mbr-section--fixed-size mbr-section--bg-adapted item dark center mbr-section--full-height" style="background-image: url(assets/images/iphone-1067975-1920-1920x1439-26.jpg);">
                    <div class="mbr-box__magnet mbr-box__magnet--sm-padding mbr-after-navbar">
                        <div class=" container">
                              <h1 class="mbr-hero__text">NO TE MOJES CON OTROS</h1>
								<p class="mbr-hero__subtext">Nosotros te implantamos un modelo de Integración Continua y Entrega Continua para que consigas que tu empresa sea DEV-Ops friendly.</p>
        ...
        <div class="row">
            <div>
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        <div>
                            <h3>CONTROL VERSIONES FUENTES</h3>
            ...
            <div>
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        <div>
                            <h3>ORQUESTACIÓN / COMPILACIÓN</h3>
                            <p>Sed egestas urna quam, sit amet euismod ligula commodo vitae. Cras hendrerit quam est, non dapibus turpis porta in. Fusce viverra, lectus vitae dignissim interdum, erat leo egestas velit, eu tincidunt tellus eros a mauris. </p>
                        </div>
                        <p class="group"><a href="https://mobirise.com/bootstrap-template/" class="btn btn-default">LEARN MORE</a></p>
                    </div>
            ...
            <div>
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        <div>
                            <h3>PRUEBAS UNITARIAS Y DE CALIDAD DE CÓDIGO</h3>
                            <p>Sed egestas urna quam, sit amet euismod ligula commodo vitae. Cras hendrerit quam est, non dapibus turpis porta in. Fusce viverra, lectus vitae dignissim interdum, erat leo egestas velit, eu tincidunt tellus eros a mauris. </p>
                        </div>
                        <p class="group"><a href="https://mobirise.com/bootstrap-template/" class="btn btn-default">LEARN MORE</a></p>
                    </div>
        ...
        <div class="row">
            <div class="mbr-box mbr-box--fixed mbr-box--adapted">
                <div class="mbr-box__magnet mbr-box__magnet--top-right mbr-section__left col-sm-6">
                    <figure class="mbr-figure mbr-figure--adapted mbr-figure--caption-inside-bottom mbr-figure--full-width"><img class="mbr-figure__img" src="assets/images/iphone-1067988-1920-1920x1440-18.jpg"></figure>
                </div>
            ...
            <div class="col-sm-6">
                <figure class="mbr-figure mbr-figure--wysiwyg mbr-figure--full-width mbr-figure--no-bg">
                    <div class="mbr-figure__map mbr-figure__map--short mbr-google-map">
                        <p class="mbr-google-map__marker" data-coordinates="40.033319, -3.600237"></p>
                    </div>
                </figure>
            </div>
            <div class="col-sm-6">
