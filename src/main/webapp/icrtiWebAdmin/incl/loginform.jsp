...
Email: administrador@icrti.es<br>
...
<footer class="mbr-section mbr-section--relative mbr-section--fixed-size" id="footer1-91" style="background-color: rgb(68, 68, 68);">
    ...
    <div class="mbr-section__container container">
        <div class="mbr-footer mbr-footer--wysiwyg row">
            <div class="col-sm-12">
                <p class="mbr-footer__copyright"></p><p>iCRTi Consulting S.L. <a href="https://mobirise.com/bootstrap-template/license.txt" target="_blank" class="text-gray">License</a></p><p></p>
            </div>
        </div>
    </div>
</footer>
